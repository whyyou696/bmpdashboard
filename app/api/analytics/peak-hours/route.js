...
export async function GET(request) {
  ...
  try {
    ...
    // Grouping
    const groups = {
      '00:00 - 06:00': { timeRange: '00:00 - 06:00', transactions: 0, revenue: 0, profit: 0 },
      '06:00 - 12:00': { timeRange: '06:00 - 12:00', transactions: 0, revenue: 0, profit: 0 },
      '12:00 - 18:00': { timeRange: '12:00 - 18:00', transactions: 0, revenue: 0, profit: 0 },
      '18:00 - 24:00': { timeRange: '18:00 - 24:00', transactions: 0, revenue: 0, profit: 0 }
    };

    currList.forEach(t => {
      const hour = new Date(t.tgl_entri).getHours();
      let grp = '18:00 - 24:00';
      if (hour >= 0 && hour < 6) grp = '00:00 - 06:00';
      else if (hour >= 6 && hour < 12) grp = '06:00 - 12:00';
      else if (hour >= 12 && hour < 18) grp = '12:00 - 18:00';

      groups[grp].transactions += 1;
      if (t.status === 20) {
        groups[grp].revenue += t.harga;
        groups[grp].profit += t.laba;
      }
    });
